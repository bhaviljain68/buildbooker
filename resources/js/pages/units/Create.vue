            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg">
                    <div class="text-gray-900">
                        ...
                        <form @submit.prevent="submitForm" class="p-7 bg-white rounded">
                            ...
                            <div v-for="(unit, index) in units" :key="index" class="unit-row mb-4 rounded-lg">
                                <div class="grid grid-cols-[1fr_1fr_12px] gap-4">
                                    <div class="pr-2">
                                        <!-- <input type="text" v-model="unit.unit_no"
                                            class="mt-1 block w-full px-3 py-3 rounded-md shadow-sm border-gray-300 focus:ring-cyan-700 focus:border-cyan-700"
                            ...
                            <div class="grid grid-cols-[1fr_1fr_12px] gap-x-4 mt-4">
